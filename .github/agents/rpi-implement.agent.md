...
7. If must-have acceptance criteria are unmet, interactive-evidence requirements are not met, or regressions occur after rework, return `FAIL` with required fixes.
